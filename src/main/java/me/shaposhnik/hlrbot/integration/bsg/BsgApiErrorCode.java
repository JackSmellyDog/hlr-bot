...
public enum BsgApiErrorCode {
  ...
  EXCEEDED_LIMIT_FOR_MESSAGES_PROCESSED_SIMULTANEOUSLY(11,
  ...
  static {
    BSG_API_ERROR_CODE_MAP = Stream.of(values())
        .collect(toMap(BsgApiErrorCode::getCode, identity()));
  }
  ...
  public static BsgApiErrorCode fromErrorCode(int errorCode) {
    return Optional.ofNullable(BSG_API_ERROR_CODE_MAP.get(errorCode))
